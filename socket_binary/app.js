...
var textoConsola = '';
    ...
    function calculate(){
        ...
        // dataASCII = String.fromCharCode.apply(null, bufView));

        dataASCII = uintToString(bufView);
        console_log(dataASCII);
        // console_log(String.fromCharCode.apply(null, bufView));
        // console_log(String.fromCharCode.apply(null, dataASCII));
